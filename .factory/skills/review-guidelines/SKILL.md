...
blockers. Avoid style-only comments unless they hide a correctness issue.
...
Prefer one issue, one reason to exist, targeted tests, a tight body, no unrelated
cleanup, no broad refactor, and no speculative claims. If a finding would broaden
the PR, say whether it should block this PR or be parked as a follow-up.
...
actionable issue, report what you checked, which objections you tried and why
they failed, and what residual risk remains.
...
evidence-backed, and useful to the human review loop.
